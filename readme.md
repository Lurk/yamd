...
[`Content::as_str`](https://docs.rs/yamd/latest/yamd/op/enum.Content.html#method.as_str), or transparently as part of [`deserialize`](https://docs.rs/yamd/latest/yamd/fn.deserialize.html)).
